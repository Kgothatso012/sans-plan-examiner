# Building Plan Analysis Workflow — Mangaung

## Step 1: Confirm Municipality
Verify erf falls under Mangaung (Bloemfontein).

## Step 2: Copy Documents to Wiki Raw Folder
```bash
cp "/path/to/application-docs/*" ~/mangaung/sans-wiki/raw/[ERF-XXX]/
```
...
## Bloemfontein Submission Checklist
...
## Mangaung-Specific Requirements
Free State winter rainfall — storm water design differs from Highveld (less intense summer storms); NHBRC mandatory; verify erf is not in agricultural holding zone
