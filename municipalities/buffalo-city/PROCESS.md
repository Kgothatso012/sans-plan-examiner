# Building Plan Analysis Workflow — Buffalo City

## Step 1: Confirm Municipality
Verify erf falls under Buffalo City (East London).

## Step 2: Copy Documents to Wiki Raw Folder
```bash
cp "/path/to/application-docs/*" ~/buffalo-city/sans-wiki/raw/[ERF-XXX]/
```
...
## East London Submission Checklist
...
## Buffalo City-Specific Requirements
Coastal zone setbacks (100m from high water mark); Amathole catchment protection areas restrict development; NHBRC mandatory; flood line along Buffalo River
